...
npx create-solana-dapp --template gh:solana-developers/solana-templates/templates/legacy-client-side
# created an pnpm based project
pnpx create-solana-dapp --template gh:solana-developers/solana-templates/templates/legacy-client-side
# created an yarn based project
yarn create solana-dapp --template gh:solana-developers/solana-templates/templates/legacy-client-side
```
...
cd solana-templates/legacy-client-side
```
